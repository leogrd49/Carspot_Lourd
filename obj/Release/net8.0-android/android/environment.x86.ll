...
@dso_cache = dso_local local_unnamed_addr global [852 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 19706304, ; hash 0x12cb1c0, from name: aot-Supabase.Postgrest.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 111379208, ; hash 0x6a38308, from name: aot-Supabase.Realtime
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 162612358, ; hash 0x9b14486, from name: MimeMapping
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 270673576, ; hash 0x102226a8, from name: libaot-Supabase
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 301263540, ; hash 0x11f4eab4, from name: aot-Supabase.Gotrue.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 337020019, ; hash 0x14168473, from name: libaot-Supabase.Gotrue
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Supabase.Gotrue.dll.so
		ptr null; void* handle (0x0)
	}, ; 60
	...
	%struct.DSOCacheEntry {
		i64 489373426, ; hash 0x1d2b3ef2, from name: Supabase.Realtime.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.40_name, ; name: libaot-Supabase.Realtime.dll.so
		ptr null; void* handle (0x0)
	}, ; 87
	...
	%struct.DSOCacheEntry {
		i64 563750616, ; hash 0x219a26d8, from name: libaot-Supabase.Storage
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 680569272, ; hash 0x2890a9b8, from name: libaot-Supabase.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-Supabase.dll.so
		ptr null; void* handle (0x0)
	}, ; 121
	...
	%struct.DSOCacheEntry {
		i64 763346851, ; hash 0x2d7fbfa3, from name: Websocket.Client
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 920281169, ; hash 0x36da6051, from name: Supabase.Functions
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 942094976, ; hash 0x38273a80, from name: libaot-CarspotLourd.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 962346654, ; hash 0x395c3e9e, from name: libaot-Supabase.Realtime
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.40_name, ; name: libaot-Supabase.Realtime.dll.so
		ptr null; void* handle (0x0)
	}, ; 173
	...
	%struct.DSOCacheEntry {
		i64 1098807696, ; hash 0x417e7990, from name: aot-Supabase.Functions.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Supabase.Functions.dll.so
		ptr null; void* handle (0x0)
	}, ; 198
	...
	%struct.DSOCacheEntry {
		i64 1116395437, ; hash 0x428ad7ad, from name: Supabase.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-Supabase.dll.so
		ptr null; void* handle (0x0)
	}, ; 200
	...
	%struct.DSOCacheEntry {
		i64 1176722390, ; hash 0x46235bd6, from name: MimeMapping.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.37_name, ; name: libaot-MimeMapping.dll.so
		ptr null; void* handle (0x0)
	}, ; 212
	...
	%struct.DSOCacheEntry {
		i64 1291715051, ; hash 0x4cfe01eb, from name: libaot-Supabase.Postgrest.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.39_name, ; name: libaot-Supabase.Postgrest.dll.so
		ptr null; void* handle (0x0)
	}, ; 233
	%struct.DSOCacheEntry {
		i64 1298598085, ; hash 0x4d6708c5, from name: CarspotLourd
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CarspotLourd.dll.so
		ptr null; void* handle (0x0)
	}, ; 234
	...
	%struct.DSOCacheEntry {
		i64 1318674371, ; hash 0x4e995fc3, from name: aot-Supabase.Core
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.41_name, ; name: libaot-Supabase.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 238
	%struct.DSOCacheEntry {
		i64 1321082218, ; hash 0x4ebe1d6a, from name: libaot-Supabase.Functions
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Supabase.Functions.dll.so
		ptr null; void* handle (0x0)
	}, ; 239
	...
	%struct.DSOCacheEntry {
		i64 1336984896, ; hash 0x4fb0c540, from name: Supabase.Core
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.41_name, ; name: libaot-Supabase.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 246
	...
	%struct.DSOCacheEntry {
		i64 1372810143, ; hash 0x51d36b9f, from name: aot-Websocket.Client.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.46_name, ; name: libaot-Websocket.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 255
	...
	%struct.DSOCacheEntry {
		i64 1496745838, ; hash 0x5936876e, from name: libaot-MimeMapping
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.37_name, ; name: libaot-MimeMapping.dll.so
		ptr null; void* handle (0x0)
	}, ; 291
	...
	%struct.DSOCacheEntry {
		i64 1516168485, ; hash 0x5a5ee525, from name: Supabase.Gotrue
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Supabase.Gotrue.dll.so
		ptr null; void* handle (0x0)
	}, ; 295
	...
	%struct.DSOCacheEntry {
		i64 1708777271, ; hash 0x65d9df37, from name: libaot-Supabase.Gotrue.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Supabase.Gotrue.dll.so
		ptr null; void* handle (0x0)
	}, ; 318
	...
	%struct.DSOCacheEntry {
		i64 1719612393, ; hash 0x667f33e9, from name: aot-Supabase.Realtime.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.40_name, ; name: libaot-Supabase.Realtime.dll.so
		ptr null; void* handle (0x0)
	}, ; 320
	...
	%struct.DSOCacheEntry {
		i64 1867499486, ; hash 0x6f4fc7de, from name: aot-Supabase.Functions
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Supabase.Functions.dll.so
		ptr null; void* handle (0x0)
	}, ; 354
	...
	%struct.DSOCacheEntry {
		i64 1905229946, ; hash 0x718f807a, from name: aot-Supabase.Storage.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.43_name, ; name: libaot-Supabase.Storage.dll.so
		ptr null; void* handle (0x0)
	}, ; 363
	...
	%struct.DSOCacheEntry {
		i64 1953393526, ; hash 0x746e6b76, from name: libaot-Supabase.Functions.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Supabase.Functions.dll.so
		ptr null; void* handle (0x0)
	}, ; 372
	...
	%struct.DSOCacheEntry {
		i64 2031031593, ; hash 0x790f1529, from name: aot-MimeMapping.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.37_name, ; name: libaot-MimeMapping.dll.so
		ptr null; void* handle (0x0)
	}, ; 386
	...
	%struct.DSOCacheEntry {
		i64 2085986421, ; hash 0x7c55a075, from name: Supabase.Storage.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.43_name, ; name: libaot-Supabase.Storage.dll.so
		ptr null; void* handle (0x0)
	}, ; 401
	...
	%struct.DSOCacheEntry {
		i64 2126962298, ; hash 0x7ec6de7a, from name: Supabase.Postgrest.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.39_name, ; name: libaot-Supabase.Postgrest.dll.so
		ptr null; void* handle (0x0)
	}, ; 411
	...
	%struct.DSOCacheEntry {
		i64 2128198166, ; hash 0x7ed9ba16, from name: Supabase.Realtime
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.40_name, ; name: libaot-Supabase.Realtime.dll.so
		ptr null; void* handle (0x0)
	}, ; 413
	...
	%struct.DSOCacheEntry {
		i64 2138252982, ; hash 0x7f7326b6, from name: Supabase
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-Supabase.dll.so
		ptr null; void* handle (0x0)
	}, ; 415
	...
	%struct.DSOCacheEntry {
		i64 2161795730, ; hash 0x80da6292, from name: aot-Supabase.Postgrest
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.39_name, ; name: libaot-Supabase.Postgrest.dll.so
		ptr null; void* handle (0x0)
	}, ; 422
	...
	%struct.DSOCacheEntry {
		i64 2249824252, ; hash 0x861997fc, from name: libaot-Supabase.Core
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.41_name, ; name: libaot-Supabase.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 443
	...
	%struct.DSOCacheEntry {
		i64 2279430281, ; hash 0x87dd5889, from name: aot-CarspotLourd
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CarspotLourd.dll.so
		ptr null; void* handle (0x0)
	}, ; 450
	...
	%struct.DSOCacheEntry {
		i64 2492117621, ; hash 0x948ab275, from name: aot-Websocket.Client
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.46_name, ; name: libaot-Websocket.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 499
	...
	%struct.DSOCacheEntry {
		i64 2503855304, ; hash 0x953dccc8, from name: libaot-Supabase.Core.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.41_name, ; name: libaot-Supabase.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 501
	...
	%struct.DSOCacheEntry {
		i64 2624014891, ; hash 0x9c674a2b, from name: libaot-Supabase.Storage.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.43_name, ; name: libaot-Supabase.Storage.dll.so
		ptr null; void* handle (0x0)
	}, ; 529
	%struct.DSOCacheEntry {
		i64 2629280487, ; hash 0x9cb7a2e7, from name: aot-Supabase.Gotrue
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Supabase.Gotrue.dll.so
		ptr null; void* handle (0x0)
	}, ; 530
	...
	%struct.DSOCacheEntry {
		i64 2631375227, ; hash 0x9cd7997b, from name: libaot-Websocket.Client.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.46_name, ; name: libaot-Websocket.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 532
	...
	%struct.DSOCacheEntry {
		i64 2734207241, ; hash 0xa2f8b109, from name: Supabase.Functions.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Supabase.Functions.dll.so
		ptr null; void* handle (0x0)
	}, ; 559
	...
	%struct.DSOCacheEntry {
		i64 2829920357, ; hash 0xa8ad2865, from name: libaot-CarspotLourd
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CarspotLourd.dll.so
		ptr null; void* handle (0x0)
	}, ; 580
	...
	%struct.DSOCacheEntry {
		i64 2836671317, ; hash 0xa9142b55, from name: libaot-Websocket.Client
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.46_name, ; name: libaot-Websocket.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 584
	...
	%struct.DSOCacheEntry {
		i64 2970034478, ; hash 0xb107212e, from name: aot-MimeMapping
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.37_name, ; name: libaot-MimeMapping.dll.so
		ptr null; void* handle (0x0)
	}, ; 607
	...
	%struct.DSOCacheEntry {
		i64 3003580589, ; hash 0xb30700ad, from name: aot-Supabase.Storage
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.43_name, ; name: libaot-Supabase.Storage.dll.so
		ptr null; void* handle (0x0)
	}, ; 615
	...
	%struct.DSOCacheEntry {
		i64 3093749295, ; hash 0xb866de2f, from name: aot-Supabase
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-Supabase.dll.so
		ptr null; void* handle (0x0)
	}, ; 637
	...
	%struct.DSOCacheEntry {
		i64 3145627561, ; hash 0xbb7e77a9, from name: Websocket.Client.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.46_name, ; name: libaot-Websocket.Client.dll.so
		ptr null; void* handle (0x0)
	}, ; 650
	%struct.DSOCacheEntry {
		i64 3155950181, ; hash 0xbc1bfa65, from name: Supabase.Core.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.41_name, ; name: libaot-Supabase.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 651
	...
	%struct.DSOCacheEntry {
		i64 3281326145, ; hash 0xc3951041, from name: CarspotLourd.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CarspotLourd.dll.so
		ptr null; void* handle (0x0)
	}, ; 672
	...
	%struct.DSOCacheEntry {
		i64 3446024977, ; hash 0xcd662b11, from name: aot-Supabase.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.42_name, ; name: libaot-Supabase.dll.so
		ptr null; void* handle (0x0)
	}, ; 698
	...
	%struct.DSOCacheEntry {
		i64 3549627300, ; hash 0xd39303a4, from name: libaot-Supabase.Realtime.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.40_name, ; name: libaot-Supabase.Realtime.dll.so
		ptr null; void* handle (0x0)
	}, ; 714
	...
	%struct.DSOCacheEntry {
		i64 3568580424, ; hash 0xd4b43748, from name: Supabase.Gotrue.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-Supabase.Gotrue.dll.so
		ptr null; void* handle (0x0)
	}, ; 718
	...
	%struct.DSOCacheEntry {
		i64 3607666123, ; hash 0xd7089dcb, from name: Supabase.Postgrest
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.39_name, ; name: libaot-Supabase.Postgrest.dll.so
		ptr null; void* handle (0x0)
	}, ; 726
	...
	%struct.DSOCacheEntry {
		i64 3744014956, ; hash 0xdf29226c, from name: aot-CarspotLourd.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-CarspotLourd.dll.so
		ptr null; void* handle (0x0)
	}, ; 755
	...
	%struct.DSOCacheEntry {
		i64 3980364293, ; hash 0xed3f8a05, from name: Supabase.Storage
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.43_name, ; name: libaot-Supabase.Storage.dll.so
		ptr null; void* handle (0x0)
	}, ; 792
	...
	%struct.DSOCacheEntry {
		i64 4140394482, ; hash 0xf6c967f2, from name: libaot-Supabase.Postgrest
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.39_name, ; name: libaot-Supabase.Postgrest.dll.so
		ptr null; void* handle (0x0)
	}, ; 821
	...
	%struct.DSOCacheEntry {
		i64 4152887511, ; hash 0xf78808d7, from name: libaot-MimeMapping.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.37_name, ; name: libaot-MimeMapping.dll.so
		ptr null; void* handle (0x0)
	}, ; 824
	...
	%struct.DSOCacheEntry {
		i64 4282306238, ; hash 0xff3ecebe, from name: aot-Supabase.Core.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.41_name, ; name: libaot-Supabase.Core.dll.so
		ptr null; void* handle (0x0)
	}, ; 846
...
@assembly_store_bundled_assemblies = dso_local local_unnamed_addr global [172 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 4
